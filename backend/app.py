...
MODEL_PATH = os.path.join(os.path.dirname(__file__), '..', 'Models', 'densenet_201_brain_tumor.pth')
...
# backend\uploads\1746728396421-588194410-BARK8345.JPG
    ...
    full_image_path = os.path.normpath(os.path.join(os.path.dirname(__file__), relative_image_path))
    ...
    if not os.path.exists(full_image_path):
        ...
        #  alt_path = os.path.join(IMAGE_BASE_PATH, 'uploads', os.path.basename(relative_image_path))
         alt_path = os.path.join(os.path.dirname(__file__), "uploads", os.path.basename(relative_image_path))
